...
def generate_deterministic_urn(entity_type: str, name: str, namespace: Optional[str] = None) -> str:
    """
...
def recreate_container_id(container_type: str, **params) -> str:
    ...
    param_dict = {k: v for k, v in params.items() if k in allowed_params and v is not None}
    
    # Generate the GUID
    return datahub_guid(param_dict)


def get_environment_aware_urn(entity_type, name, environment_config=None, container_params=None, parent_path=None):
    """
