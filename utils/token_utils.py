...
def get_token() -> Optional[str]:
    ...
    if not token or token == "your_datahub_pat_token_here":
        logger.warning("Warning: DATAHUB_TOKEN is not set. Will attempt to connect without authentication.")
        logger.warning("This will only work if your DataHub instance doesn't require authentication.")
        return None
