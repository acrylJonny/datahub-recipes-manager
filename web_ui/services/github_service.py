    ...
    def create_environment(self, name: str, wait_timer: int = 0, reviewers: list = None, 
                          prevent_self_review: bool = False, 
                          protected_branches: bool = False) -> bool:
        """
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                ...
                logger.error(f"Failed to create/update environment. Status: {response.status_code}, Response: {response.text}")
                return False
