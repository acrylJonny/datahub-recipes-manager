...
def get_item(dictionary, key):
    ...
    if isinstance(dictionary, dict):
        ...
        logger.debug(f"get_item: key {key} not found in dictionary keys: {list(dictionary.keys())}")
        return []
...
@register.inclusion_tag('metadata_manager/glossary/includes/node_hierarchy.html', takes_context=True)
