...
""",
        ...
        if not mysql_instance_file.exists():
            mysql_instance = {
                ...
                "secret_references": ["USERNAME", "PASSWORD"],
            }
        ...
        if not recipe_instance_file.exists():
            ...
            self.stdout.write(
                f"Created example recipe instance: {recipe_instance_file}"
            )
        ...
        if not default_params_file.exists():
            default_params = {
                ...
                "execution": {"timeout": 300, "retry": 3, "debug": False},
            }
...
"""
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Repository structure initialized successfully with {created_count} new directories"
            )
        )
