...
class WebUiConfig(AppConfig):
    ...
    def ready(self):
        ...
        if any(arg in sys.argv for arg in ['migrate', 'shell', 'collectstatic', 'makemigrations']):
            return
        ...
        try:
            ...
            if not settings_table_exists:
                logger.info("Settings table does not exist yet, skipping initialization")
                return
                        ...
                        for line in f:
                            ...
                            if '=' in line:
                                ...
                                try:
                                    ...
                                    logger.warning(f"Could not set setting {key}: {str(e)}")
