...
class GitHubService:
    ...
    def get_file_content(self, path: str, ref: str = "main") -> Optional[Dict]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.error(
                    f"Failed to get file content. Status: {response.status_code}, Response: {response.text}"
                )
                return None
    ...
    def create_branch(self, branch_name: str, base_branch: str = "main") -> bool:
        ...
        try:
            response = requests.get(
                f"{self.base_url}/git/ref/heads/{base_branch}", headers=self.headers
            )

            if response.status_code != 200:
                logger.error(
                    f"Failed to get base branch ref. Status: {response.status_code}, Response: {response.text}"
                )
                return False
            ...
            response = requests.post(
                f"{self.base_url}/git/refs", headers=self.headers, json=payload
            )
            ...
            if response.status_code == 201:
                ...
                logger.error(
                    f"Failed to create branch. Status: {response.status_code}, Response: {response.text}"
                )
                return False
    ...
    def commit_file(
        self, path: str, content: str, branch: str, message: str, update: bool = False
    ) -> bool:
        """
        ...
        try:
            ...
            if response.status_code in [200, 201]:
                ...
                logger.error(
                    f"Failed to commit file. Status: {response.status_code}, Response: {response.text}"
                )
                return False
    ...
    def commit_policy(
        self, policy_data: dict, branch: str, policy_name: str = None
    ) -> bool:
        """
        ...
        try:
            ...
            if (
                ...
                and "name" in policy_data["policy"]
            ):
            ...
            yaml_content = yaml.dump(
                policy_data, default_flow_style=False, sort_keys=False
            )
    ...
    def commit_env_vars(
        self, env_vars_data: dict, branch: str, instance_name: str
    ) -> bool:
        """
        ...
        try:
            ...
            # Convert to YAML
            yaml_content = yaml.dump(
                env_vars_data, default_flow_style=False, sort_keys=False
            )
    ...
    def create_pull_request(
        ...
        try:
            ...
            if response.status_code == 201:
                ...
                logger.error(
                    f"Failed to create PR. Status: {response.status_code}, Response: {response.text}"
                )
                return None
    ...
    def get_pull_request(self, pr_number: int) -> Optional[Dict]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.error(
                    f"Failed to get PR. Status: {response.status_code}, Response: {response.text}"
                )
                return None
    ...
    def sync_recipe_to_github(
        self,
        recipe_id: str,
        recipe_name: str,
        recipe_data: Dict,
        recipe_description: str = "",
        recipe_type: str = "batch",
        ...
        try:
            ...
            # Commit the file
            if not self.commit_file(
                path, content, branch_name, commit_message, update=True
            ):
    ...
    def get_repository_secrets(self) -> List[Dict]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.error(
                    f"Failed to get repository secrets. Status: {response.status_code}, Response: {response.text}"
                )
                return []
    ...
    def get_environments(self) -> List[Dict]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.error(
                    f"Failed to get environments. Status: {response.status_code}, Response: {response.text}"
                )
                return []
    ...
    def get_environment_secrets(self, environment: str) -> List[Dict]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                logger.error(
                    f"Failed to get environment secrets. Status: {response.status_code}, Response: {response.text}"
                )
                return []
    ...
    def create_or_update_secret(self, name: str, value: str) -> bool:
        ...
        try:
            ...
            if key_response.status_code != 200:
                logger.error(
                    f"Failed to get repository public key. Status: {key_response.status_code}, Response: {key_response.text}"
                )
                return False
            ...
            try:
                ...
                public_key_obj = public.PublicKey(
                    public_key_bytes, encoding.Base64Encoder()
                )
                ...
                encrypted_value_b64 = (
                    encoding.Base64Encoder().encode(encrypted_value).decode("utf-8")
                )
                ...
                secret_response = requests.put(
                    secret_url, headers=self.headers, json=secret_data
                )
                ...
                if secret_response.status_code in [201, 204]:
                    ...
                    logger.error(
                        f"Failed to create/update secret. Status: {secret_response.status_code}, Response: {secret_response.text}"
                    )
                    return False

            except ImportError:
                logger.error(
                    "PyNaCl library not installed. Required for GitHub secret encryption."
                )
                return False
    ...
    def create_or_update_environment_secret(
        ...
        try:
            ...
            if key_response.status_code != 200:
                logger.error(
                    f"Failed to get environment public key. Status: {key_response.status_code}, Response: {key_response.text}"
                )
                return False
            ...
            try:
                ...
                if secret_response.status_code in [201, 204]:
                    ...
                    logger.error(
                        f"Failed to create/update environment secret. Status: {secret_response.status_code}, Response: {secret_response.text}"
                    )
                    return False
    ...
    def delete_secret(self, name: str) -> bool:
        ...
        try:
            ...
            if response.status_code in [
                ...
                logger.error(
                    f"Failed to delete secret. Status: {response.status_code}, Response: {response.text}"
                )
                return False
    ...
    def create_secrets_from_env_vars(
        self, env_vars_dict: Dict, environment: str = None
    ) -> Dict:
        """
        ...
        if environment:
            try:
                ...
                if not has_environment:
                    logger.warning(
                        f"Environment '{environment}' not found in GitHub. Secrets will be created at repository level."
                    )
                else:
            ...
            try:
                ...
                if environment and has_environment:
                    ...
                    success = self.create_or_update_environment_secret(
                        environment=environment, name=key, value=value
                    )
                else:
                    # Create repository-level secret
                    success = self.create_or_update_secret(name=key, value=value)
