...
def parse_args():
    ...
    """
    parser = argparse.ArgumentParser(description="List glossary nodes and terms from DataHub")
...
def build_hierarchy(nodes: List[Dict[str, Any]], terms: List[Dict[str, Any]]) -> Dict[str, Any]:
    """
...
def main():
    ...
    try:
        ...
        if not args.terms_only:
            ...
            if args.include_children:
                ...
                for node in nodes:
                    ...
                    if node_urn:
                        detailed_node = client.export_glossary_node(node_urn, include_children=True)
                        if detailed_node:
        ...
        if args.nodes_only:
            ...
            logger.info(f"Retrieved {node_count} glossary nodes and {term_count} glossary terms from DataHub")
