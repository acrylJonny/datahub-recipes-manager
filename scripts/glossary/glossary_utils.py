...
def load_glossary_node_from_file(file_path: str) -> Dict[str, Any]:
    ...
    try:
        ...
        if "glossaryNode" in data:
            ...
            logger.warning(
                "Glossary node definition not found in expected format, using entire file content"
            )
            return data
...
def save_glossary_node_to_file(
    node: Dict[str, Any], file_path: str, pretty_print: bool = True
) -> bool:
    """
...
def check_glossary_node_dependencies(
    client: DataHubMetadataApiClient, node_urn: str
) -> bool:
    """
...
def load_glossary_term_from_file(file_path: str) -> Dict[str, Any]:
    ...
    try:
        ...
        if "glossaryTerm" in data:
            ...
            logger.warning(
                "Glossary term definition not found in expected format, using entire file content"
            )
            return data
    except Exception as e:
...
def save_glossary_term_to_file(
    term: Dict[str, Any], file_path: str, pretty_print: bool = True
) -> bool:
    """
...
def check_glossary_term_dependencies(
    client: DataHubMetadataApiClient, term_urn: str
) -> bool:
    """
