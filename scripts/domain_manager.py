...
Examples:
  ...
  python domain_manager.py delete --server-url http://localhost:8080 --domain-urn urn:li:domain:engineering
    ...
    list_parser = subparsers.add_parser(
        "list", parents=[common_parser], help="List domains"
    )
    ...
    get_parser = subparsers.add_parser(
        "get", parents=[common_parser], help="Get a specific domain"
    )
    ...
    create_parser = subparsers.add_parser(
        "create", parents=[common_parser], help="Create a new domain"
    )
    ...
    update_parser = subparsers.add_parser(
        "update", parents=[common_parser], help="Update an existing domain"
    )
    ...
    delete_parser = subparsers.add_parser(
        "delete", parents=[common_parser], help="Delete a domain"
    )
