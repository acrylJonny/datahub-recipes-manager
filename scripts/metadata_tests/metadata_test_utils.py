...
class MetadataTestSuite:
    ...
    def save_results(self, results: Dict[str, List[TestResult]], output_file: str) -> None:
        """
...
def check_string_length(
    ...
    if not isinstance(value, str):
        return False, f"Field '{field_name}' is not a string", {"type": str(type(value))}
    ...
    if min_length is not None and length < min_length:
        ...
        return False, f"Field '{field_name}' is too short ({length} chars, minimum {min_length})", details
    
    if max_length is not None and length > max_length:
        details["maxLength"] = max_length
        return False, f"Field '{field_name}' is too long ({length} chars, maximum {max_length})", details
