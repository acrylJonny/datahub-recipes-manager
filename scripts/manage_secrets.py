...
def main():
    ...
    list_parser.add_argument("--limit", type=int, default=100, help="Maximum number of secrets to return")
    
    # Delete secret parser
    delete_parser = subparsers.add_parser("delete", help="Delete a secret")
    delete_parser.add_argument("--name", required=True, help="Secret name or URN to delete")
