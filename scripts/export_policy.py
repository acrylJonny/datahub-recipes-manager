...
def main():
    ...
    parser.add_argument(
        ...
        help="Directory to save exported policies",
    )
    parser.add_argument(
        "--policy-id",
        help="Specific policy ID to export (exports all if not specified)",
    )
    parser.add_argument(
    ...
    logger.info(
        f"Successfully exported {len(exported_files)} policies to {args.output_dir}"
    )
