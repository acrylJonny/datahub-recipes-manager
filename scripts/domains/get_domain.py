...
def parse_args():
    ...
    """
    parser = argparse.ArgumentParser(description="Get details of a specific domain from DataHub")
...
def main():
    ...
    try:
        ...
        domain = client.export_domain(args.domain_urn, include_entities=args.include_entities)
