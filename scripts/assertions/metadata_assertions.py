...
def get_deterministic_glossary_term_urn(
    term_name: str, parent_urn: Optional[str] = None
) -> str:
    """
...
def assert_entity_has_tag(
    ...
    variables = {"entityUrn": entity_urn, "tagUrn": tag_urn}
...
def assert_entity_has_glossary_term(
    ...
    variables = {"entityUrn": entity_urn, "termUrn": term_urn}
...
def assert_entity_has_structured_property(
    ...
    try:
        ...
        if property_name not in properties:
            return AssertionResult(
                ...
                f"Entity {entity_urn} does not have structured property '{property_name}'",
                {
                    ...
                    "presentProperties": list(properties.keys()),
                },
            )
        ...
        value_info = (
            f" with value '{actual_value}'" if expected_value is not None else ""
        )
        return AssertionResult(
            True,
...
def assert_all_entities_of_type_have_tag(
    ...
    try:
        ...
        while True:
            variables = {"type": entity_type, "start": start, "count": count}
            ...
            for search_result in search_results:
                ...
                if "tags" in entity and "tags" in entity["tags"]:
...
def run_assertions(
    assertions: List[Dict[str, Any]], use_deterministic_urns: bool = True
) -> Dict[str, Any]:
    """
