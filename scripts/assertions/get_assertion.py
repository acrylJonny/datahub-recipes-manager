...
from scripts.assertions.assertion_utils import get_assertion_entity_urn, get_assertion_type, save_assertion_to_file
...
def main():
    ...
    try:
        ...
        # Output assertion
        if args.output_file:
            success = save_assertion_to_file(result, args.output_file, args.pretty_print)
            if success:
