...
from scripts.assertions.assertion_utils import get_assertion_entity_urn, get_assertion_type
...
def main():
    ...
    try:
        ...
        for assertion in assertions:
            ...
            assertions_with_summary.append({
                "summary": summary,
                "details": assertion
            })
        ...
        if args.output_file:
            ...
            logger.info(f"Successfully saved {len(assertions)} assertions to {args.output_file}")
        else:
            # Print to stdout
