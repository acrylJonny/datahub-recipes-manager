...
def list_secrets(client: DataHubRestClient, output_format: str = "text", limit: int = 100) -> List[Dict[str, Any]]:
    """
...
def main():
    ...
    if not secrets and not args.format == "json":
        logger.warning("No secrets were found. This could be normal if none have been created yet.")
